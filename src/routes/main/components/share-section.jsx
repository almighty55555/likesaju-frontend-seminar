      ...
      <div className="w-full h-full flex flex-col gap-[80px]">
        <div className="w-full flex mobile:flex-col justify-between items-center mobile:gap-4">
          <div className="space-y-6 mobile:space-y-2">
            ...
            <p className="text-xl mobile:text-sm font-bold text-neutral-800 dark:text-white">
              채팅으로 사주를 공유해보세요
            </p>
          </div>
          <a href="/chat">
        ...
        <div className="flex mobile:flex-col gap-10 justify-center">
  ...
  return (
    <div className="flex flex-col rounded-xl shadow-md max-w-[450px] max-h-[378px] overflow-hidden dark:bg-neutral-400">
      ...
      <div className="p-5 flex flex-col items-start gap-1.5">
        <h4 className="text-base mobile:text-sm font-normal text-neutral-800">
          {title}
        </h4>
        <p className="text-xl mobile:text-base font-extrabold text-neutral-800">
          {description}
        </p>
      </div>
    </div>
