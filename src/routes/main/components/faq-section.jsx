...
export const FAQSection = () => {
  ...
  return (
    <SectionLayout>
      <div className="w-full h-full flex flex-col gap-[80px] mobile:gap-6">
        <h3 className="text-left text-4xl mobile:text-center mobile:text-2xl nanum-extra-bold">FAQs</h3>
...
const FAQAccordion = ({ question, answer }) => {
  ...
  return (
    <div className="flex flex-col rounded-xl px-[50px] py-10 mobile:px-[35px] mobile:py-6 shadow-2xl mobile:shadow-lg w-full gap-5">
      <div className="flex justify-between items-center gap-5">
        <p className="text-xl mobile:text-base font-bold mobile:font-semibold truncate">{question}</p>
        <button
      ...
      >
        <p className="text-lg mobile:text-sm w-full text-left mt-4">{answer}</p>
      </div>
    </div>
  );
};
